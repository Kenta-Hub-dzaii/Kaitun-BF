...
local keys = {
    ["KentaHub_10dj29319rj"] = true,
    ["KentaHub_10eu39dir2i"] = true,
    ["KentaHub_1pf8fj3jf92"] = true,
    ["KentaHub_10d9fjej3if"] = true
}
...
Wallpaper.Image = "rbxassetid://105095286276153"
...
-- ====== Cheese Escape Locator + Rainbow FPS (Không cần key) ======
...
elseif game.PlaceId == 7449423635 then
    ...
    game.Players.LocalPlayer:Kick("Game Not Supported.Join Discord For More Info\n")
end
...
if getgenv().SettingFarm["Auto Chat"]["Enabled"] then
    task.spawn(function()
        while true do
            pcall(function()
                game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(
                    getgenv().SettingFarm["Auto Chat"]["Text"],
                    "All"
                )
            end)
            wait(tonumber(getgenv().SettingFarm["Auto Chat"]["Delay"]))
        end
    end)
end
...
-- Boost Fps
if getgenv().SettingFarm["Boost Fps"] then
    task.spawn(function()
        ...
        local function optimizePart(p)
            if p:IsA("BasePart") then
                p.Material = Enum.Material.Plastic
                p.Reflectance = 0
            elseif (p:IsA("Decal") or p:IsA("Texture")) and decalsyeeted then
                p.Transparency = 1
        ...
        local function applyBoost()
            ...
            pcall(function()
                ...
                lg.FogEnd = 9e9
                lg.Brightness = 0
                for _, e in pairs(lg:GetChildren()) do
            ...
            -- Terrain
            pcall(function()
                sethiddenproperty(tr, "Decoration", false)
                tr.WaterWaveSize = 0
                tr.WaterWaveSpeed = 0
                tr.WaterReflectance = 0
                tr.WaterTransparency = 0
            end)
...
task.spawn(function()
    ...
    local waterPlane = Workspace:WaitForChild("Map"):WaitForChild("WaterBase-Plane")

    while task.wait(1) do
        if waterPlane and waterPlane:IsA("Part") then
            -- Ép nước dày để đứng được
            waterPlane.Size = Vector3.new(waterPlane.Size.X, 112, waterPlane.Size.Z)
        end
    end
end)
...
-- Hàm tắt NoClip và khôi phục CanCollide
...
if getgenv().SettingFarm["Black Screen"] then
    pcall(function()
        ...
        RunService:Set3dRenderingEnabled(false) -- Tắt 3D render để giảm GPU/CPU
        if blur then blur.Enabled = false end -- Tắt blur nếu có
    end)
end
...
-- Hàm lấy danh sách server khả dụng
local function getServers()
    ...
    repeat
        local url = ("https://games.roblox.com/v1/games/%d/servers/Public?limit=100&sortOrder=Desc"):format(placeId)
        ...
        if success and result and result.data then
            ...
            warn("Lỗi khi lấy server:", result)
            break
        end
    until cursor == ""
...
-- Hàm hop: chỉ teleport server mới
function Hop()
    local allServers = getServers()
    if #allServers == 0 then
        task.wait(1)
        return Hop()
    end

    for _, serverId in ipairs(allServers) do
    ...
    -- Nếu vẫn fail thì thử lại
    return Hop()
end

-- Tự động check player mỗi 1s, nếu gặp target thì hop luôn
spawn(function()
    while true do
        task.wait(1)
...
local Stats2_1 = Instance.new("Frame")
local UICorner_2 = Instance.new("UICorner")
local Dsc_1 = Instance.new("TextLabel")
local StatusLabel_1 = Instance.new("TextLabel")
local UIStroke_1 = Instance.new("UIStroke")
local JobID_1 = Instance.new("Frame")
local UIStroke_2 = Instance.new("UIStroke")
local UICorner_3 = Instance.new("UICorner")
local InputJobId_1 = Instance.new("TextBox")
local UICorner_4 = Instance.new("UICorner")
local UIAspectRatioConstraint_1 = Instance.new("UIAspectRatioConstraint")
local FakeBlur_1 = Instance.new("Frame")
local UICorner_5 = Instance.new("UICorner")
local Stats_1 = Instance.new("Frame")
local UICorner_6 = Instance.new("UICorner")
local StatusLabel_2 = Instance.new("TextLabel")
local UIStroke_3 = Instance.new("UIStroke")
local Line_1 = Instance.new("Frame")
local StatsAcc_1 = Instance.new("TextLabel")
local Lv_1 = Instance.new("TextLabel")
local Race_1 = Instance.new("TextLabel")
local Beli_1 = Instance.new("TextLabel")
local Frag_1 = Instance.new("TextLabel")
local Line2_1 = Instance.new("Frame")
local Valk_1 = Instance.new("TextLabel")
local CDk_1 = Instance.new("TextLabel")
local God_1 = Instance.new("TextLabel")
local Skull_1 = Instance.new("TextLabel")
local Sea_1 = Instance.new("TextLabel")
...
Main_1.Size = UDim2.new(0.600000024, 0,0.600000024, 0)

FakeBlur2_1.Name = "FakeBlur2"
FakeBlur2_1.Parent = Main_1
FakeBlur2_1.BackgroundColor3 = Color3.fromRGB(0,0,0)
FakeBlur2_1.BackgroundTransparency = 0.44999998807907104
FakeBlur2_1.BorderSizePixel = 0
FakeBlur2_1.Position = UDim2.new(-0.0177938901, 0,-0.49639535, 0)
FakeBlur2_1.Size = UDim2.new(1.04397023, 0,0.234688327, 0)

UICorner_1.Parent = FakeBlur2_1
UICorner_1.CornerRadius = UDim.new(0,4)

Stats2_1.Name = "Stats2"
Stats2_1.Parent = FakeBlur2_1
Stats2_1.BackgroundColor3 = Color3.fromRGB(0,0,0)
Stats2_1.BackgroundTransparency = 0.75
Stats2_1.BorderSizePixel = 0
Stats2_1.Position = UDim2.new(0.00191382074, 0,-0.027786579, 0)
Stats2_1.Size = UDim2.new(1.00063157, 0,1.00967026, 0)

UICorner_2.Parent = Stats2_1
UICorner_2.CornerRadius = UDim.new(0,5)

Dsc_1.Name = "Dsc"
Dsc_1.Parent = Stats2_1
Dsc_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Dsc_1.BackgroundTransparency = 1
Dsc_1.Position = UDim2.new(0.248431668, 0,-0.368459851, 0)
Dsc_1.Size = UDim2.new(0.5, 0,0.300000012, 0)
Dsc_1.Font = Enum.Font.FredokaOne
Dsc_1.Text = "discord.gg/dBmXyaJhuK"
Dsc_1.TextColor3 = Color3.fromRGB(255,255,255)
Dsc_1.TextScaled = true
Dsc_1.TextSize = 5
Dsc_1.TextWrapped = true

StatusLabel_1.Name = "StatusLabel"
StatusLabel_1.Parent = Stats2_1
StatusLabel_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
StatusLabel_1.BackgroundTransparency = 1
StatusLabel_1.Position = UDim2.new(0.243919775, 0,0.344587982, 0)
StatusLabel_1.Size = UDim2.new(0.5, 0,0.300000012, 0)
StatusLabel_1.Font = Enum.Font.FredokaOne
StatusLabel_1.Text = "Status: Kaitun Is Running..."
StatusLabel_1.TextColor3 = Color3.fromRGB(255,255,255)
StatusLabel_1.TextSize = 25
StatusLabel_1.TextWrapped = true

UIStroke_1.Parent = Stats2_1
UIStroke_1.Color = Color3.fromRGB(255,255,255)
UIStroke_1.Thickness = 2.799999952316284

JobID_1.Name = "JobID"
JobID_1.Parent = Main_1
JobID_1.BackgroundColor3 = Color3.fromRGB(26,26,26)
JobID_1.BackgroundTransparency = 0.699999988079071
JobID_1.Position = UDim2.new(0.224593461, 0,1.06867003, 0)
JobID_1.Size = UDim2.new(0.582571208, 0,0.130487815, 0)

UIStroke_2.Parent = JobID_1
UIStroke_2.Color = Color3.fromRGB(255,255,255)
UIStroke_2.Thickness = 2.200000047683716

UICorner_3.Parent = JobID_1

InputJobId_1.Name = "InputJobId"
InputJobId_1.Parent = JobID_1
InputJobId_1.Active = true
InputJobId_1.BackgroundColor3 = Color3.fromRGB(26,26,26)
InputJobId_1.BackgroundTransparency = 0.3499999940395355
InputJobId_1.CursorPosition = -1
InputJobId_1.Position = UDim2.new(-0.000634285563, 0,-0.0405839384, 0)
InputJobId_1.Size = UDim2.new(1.00297701, 0,1.03397059, 0)
InputJobId_1.Font = Enum.Font.FredokaOne
InputJobId_1.PlaceholderText = "Input JobID"
InputJobId_1.Text = ""
InputJobId_1.TextColor3 = Color3.fromRGB(255,255,255)
InputJobId_1.TextSize = 13
InputJobId_1.TextWrapped = true

UICorner_4.Parent = InputJobId_1

UIAspectRatioConstraint_1.Parent = Main_1
UIAspectRatioConstraint_1.AspectRatio = 1.600000023841858

FakeBlur_1.Name = "FakeBlur"
FakeBlur_1.Parent = Main_1
FakeBlur_1.BackgroundColor3 = Color3.fromRGB(0,0,0)
FakeBlur_1.BackgroundTransparency = 0.3499999940395355
FakeBlur_1.BorderSizePixel = 0
FakeBlur_1.Position = UDim2.new(-0.193111777, 0,-0.23092334, 0)
FakeBlur_1.Size = UDim2.new(1.41549873, 0,1.25112402, 0)

UICorner_5.Parent = FakeBlur_1
UICorner_5.CornerRadius = UDim.new(0,4)

Stats_1.Name = "Stats"
Stats_1.Parent = FakeBlur_1
Stats_1.BackgroundColor3 = Color3.fromRGB(0,0,0)
Stats_1.BackgroundTransparency = 0.75
Stats_1.BorderSizePixel = 0
Stats_1.Position = UDim2.new(0.0208673775, 0,0.0347678587, 0)
Stats_1.Size = UDim2.new(0.959719062, 0,0.925757349, 0)

UICorner_6.Parent = Stats_1
UICorner_6.CornerRadius = UDim.new(0,5)

StatusLabel_2.Name = "StatusLabel"
StatusLabel_2.Parent = Stats_1
StatusLabel_2.BackgroundColor3 = Color3.fromRGB(163,162,165)
StatusLabel_2.BackgroundTransparency = 1
...
UIStroke_3.Parent = Stats_1
UIStroke_3.Color = Color3.fromRGB(255,255,255)
UIStroke_3.Thickness = 2.799999952316284

Line_1.Name = "Line"
Line_1.Parent = Stats_1
Line_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
Line_1.BorderColor3 = Color3.fromRGB(0,0,0)
Line_1.BorderSizePixel = 0
Line_1.Position = UDim2.new(0.1, 0, 0.121077582, 0)
Line_1.Size = UDim2.new(0.8, 0, 0, 3)

StatsAcc_1.Name = "StatsAcc"
StatsAcc_1.Parent = Stats_1
StatsAcc_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
StatsAcc_1.BackgroundTransparency = 1
StatsAcc_1.Position = UDim2.new(0.369618833, 0,0.11918015, 0)
StatsAcc_1.Size = UDim2.new(0.246080399, 0,0.126491323, 0)
StatsAcc_1.Font = Enum.Font.FredokaOne
StatsAcc_1.Text = "Account Stats"
StatsAcc_1.TextColor3 = Color3.fromRGB(255,244,94)
StatsAcc_1.TextSize = 16
StatsAcc_1.TextWrapped = true

Lv_1.Name = "Lv"
Lv_1.Parent = Stats_1
Lv_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Lv_1.BackgroundTransparency = 1
Lv_1.Position = UDim2.new(0.369618833, 0,0.244240433, 0)
Lv_1.Size = UDim2.new(0.246080399, 0,0.126491323, 0)
Lv_1.Font = Enum.Font.FredokaOne
Lv_1.Text = "Level: " .. game.Players.LocalPlayer.Data.Level.Value
Lv_1.TextColor3 = Color3.fromRGB(255,255,255)
Lv_1.TextSize = 16
Lv_1.TextWrapped = true

Race_1.Name = "Race"
Race_1.Parent = Stats_1
Race_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Race_1.BackgroundTransparency = 1
Race_1.Position = UDim2.new(0.369618833, 0,0.369300693, 0)
Race_1.Size = UDim2.new(0.246080399, 0,0.126491323, 0)
Race_1.Font = Enum.Font.FredokaOne
Race_1.Text = "Race: " .. game.Players.LocalPlayer.Data.Race.Value
Race_1.TextColor3 = Color3.fromRGB(255,255,255)
Race_1.TextSize = 16
Race_1.TextWrapped = true

Beli_1.Name = "Beli"
Beli_1.Parent = Stats_1
Beli_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Beli_1.BackgroundTransparency = 1
Beli_1.Position = UDim2.new(0.369618833, 0,0.494360983, 0)
Beli_1.Size = UDim2.new(0.246080399, 0,0.126491323, 0)
Beli_1.Font = Enum.Font.FredokaOne
Beli_1.Text = "Beli: " .. game.Players.LocalPlayer.Data.Beli.Value
Beli_1.TextColor3 = Color3.fromRGB(255,255,255)
Beli_1.TextSize = 16
Beli_1.TextWrapped = true

Frag_1.Name = "Frag"
Frag_1.Parent = Stats_1
Frag_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Frag_1.BackgroundTransparency = 1
Frag_1.Position = UDim2.new(0.369618833, 0,0.619421244, 0)
Frag_1.Size = UDim2.new(0.246080399, 0,0.126491323, 0)
Frag_1.Font = Enum.Font.FredokaOne
Frag_1.Text = "Frag: " .. game.Players.LocalPlayer.Data.Fragments.Value
Frag_1.TextColor3 = Color3.fromRGB(255,255,255)
Frag_1.TextSize = 16
Frag_1.TextWrapped = true

Line2_1.Name = "Line2"
Line2_1.Parent = Stats_1
Line2_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
Line2_1.BorderColor3 = Color3.fromRGB(0,0,0)
Line2_1.BorderSizePixel = 0
Line2_1.Position = UDim2.new(0.025, 0, 0.757810354, 0)
Line2_1.Size = UDim2.new(0.95, 0, 0, 3)

Valk_1.Name = "Valk"
Valk_1.Parent = Stats_1
Valk_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Valk_1.BackgroundTransparency = 1
Valk_1.Position = UDim2.new(0.730829358, 0,0.771507204, 0)
Valk_1.Size = UDim2.new(0.24328731, 0,0.126491308, 0)
Valk_1.Font = Enum.Font.FredokaOne
Valk_1.Text = "🔴 Valkyrie Helm"
Valk_1.TextColor3 = Color3.fromRGB(255,255,255)
Valk_1.TextSize = 14
Valk_1.TextWrapped = true

local player = game.Players.LocalPlayer
local char = player.Character or player.CharacterAdded:Wait()

local valkAccessory = nil
for _, acc in ipairs(char:GetChildren()) do
    if acc:IsA("Accessory") and string.find(string.lower(acc.Name), "valkyrie") then
        valkAccessory = acc
        break
    end
end

if valkAccessory then
    Valk_1.Text = "🟢 Valkyrie Helm"
else
    Valk_1.Text = "🔴 Valkyrie Helm"
end
...
CDk_1.Name = "CDk"
CDk_1.Parent = Stats_1
CDk_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
CDk_1.BackgroundTransparency = 1
CDk_1.Position = UDim2.new(0.337216675, 0,0.767836392, 0)
CDk_1.Size = UDim2.new(0.34232682, 0,0.126491308, 0)
CDk_1.Font = Enum.Font.FredokaOne
CDk_1.Text = "🔴 Cursed Dual Katana"
CDk_1.TextColor3 = Color3.fromRGB(255,255,255)
CDk_1.TextSize = 13
CDk_1.TextWrapped = true

local player = game.Players.LocalPlayer
local backpack = player:WaitForChild("Backpack")
local character = player.Character or player.CharacterAdded:Wait()

if backpack:FindFirstChild("Cursed Dual Katana") or character:FindFirstChild("Cursed Dual Katana") then
    CDk_1.Text  = "🟢 Cursed Dual Katana"
else
    CDk_1.Text = "🔴 Cursed Dual Katana"
end
...
God_1.Name = "God"
God_1.Parent = Stats_1
God_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
God_1.BackgroundTransparency = 1
God_1.Position = UDim2.new(0.0318200886, 0,0.771507204, 0)
God_1.Size = UDim2.new(0.200308502, 0,0.126491308, 0)
God_1.Font = Enum.Font.FredokaOne
God_1.Text = "🔴 GodHuman"
God_1.TextColor3 = Color3.fromRGB(255,255,255)
God_1.TextSize = 13
God_1.TextWrapped = true

local response = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman", true)

if type(response) == "string" and response:find("already") then
    God_1.Text  = "🟢 GodHuman"
else
    God_1.Text = "🔴 GodHuman"
end
...
Skull_1.Name = "Skull"
Skull_1.Parent = Stats_1
Skull_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Skull_1.BackgroundTransparency = 1
Skull_1.Position = UDim2.new(0.0298640262, 0,0.870948195, 0)
Skull_1.Size = UDim2.new(0.212901726, 0,0.126491308, 0)
Skull_1.Font = Enum.Font.FredokaOne
Skull_1.Text = "🔴 Skull Guitar"
Skull_1.TextColor3 = Color3.fromRGB(255,255,255)
Skull_1.TextSize = 14
Skull_1.TextWrapped = true

local player = game.Players.LocalPlayer
local backpack = player:WaitForChild("Backpack")
local character = player.Character or player.CharacterAdded:Wait()

if backpack:FindFirstChild("Skull Guitar") or character:FindFirstChild("Skull Guitar") then
    Skull_1.Text  = "🟢 Skull Guitar"
else
    Skull_1.Text = "🔴 Skull Guitar"
end
...
Sea_1.Name = "Sea"
Sea_1.Parent = Stats_1
Sea_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Sea_1.BackgroundTransparency = 1
Sea_1.Position = UDim2.new(0.336812705, 0,0.870948195, 0)
Sea_1.Size = UDim2.new(0.239021495, 0,0.126491308, 0)
Sea_1.Font = Enum.Font.FredokaOne
Sea_1.Text = "🔴 Third Sea"
Sea_1.TextColor3 = Color3.fromRGB(255,255,255)
Sea_1.TextSize = 12
Sea_1.TextWrapped = true

Pull_1.Name = "Pull"
Pull_1.Parent = Stats_1
Pull_1.BackgroundColor3 = Color3.fromRGB(163,162,165)
Pull_1.BackgroundTransparency = 1
Pull_1.Position = UDim2.new(0.73082912, 0,0.870948195, 0)
Pull_1.Size = UDim2.new(0.1871811, 0,0.126491308, 0)
Pull_1.Font = Enum.Font.FredokaOne
Pull_1.Text = "🔴 Pull Lever"
Pull_1.TextColor3 = Color3.fromRGB(255,255,255)
Pull_1.TextSize = 13
Pull_1.TextWrapped = true

task.spawn(function()
    local previousStatus = false
    ...
    while task.wait(1) do
        ...
        if success and result ~= previousStatus then
...
local function checkSingleBadge(badgeId)
    ...
    if success then
        ...
        warn("Lỗi khi kiểm tra badge:", badgeId)
        return false
    end
end

local hasBadge = checkSingleBadge(badgeId)
if hasBadge then
    Sea_1.Text = "🟢 Third Sea"
else
    Sea_1.Text = "🔴 Third Sea"
...
local function SCXVacUSCqVELbBb()
    local script = Instance.new("LocalScript",InputJobId_1)
    local TeleportService = game:GetService("TeleportService")
    local Players = game:GetService("Players")
    local player = Players.LocalPlayer
...
-- Đảm bảo StatusLabel hiển thị đầy đủ
StatusLabel_1.TextScaled = true
StatusLabel_1.TextWrapped = true
-- Blur setup
...
blur.Enabled = UIVisible
FakeBlur_1.Visible = UIVisible
...
TextButton.MouseButton1Down:Connect(function()
    ...
    blur.Enabled = UIVisible
    FakeBlur_1.Visible = UIVisible
    Main_1.Visible = UIVisible
end)

-- Auto-update stats function
...
-- Đảm bảo status label luôn hiển thị đầy đủ
task.spawn(function()
    while task.wait(0.5) do
        if StatusLabel_1.Text ~= "Status: Kaitun Is Running..." then
            StatusLabel_1.Text = "Status: Kaitun Is Running..."
        end
    end
end)
...
Module.FastAttack = (function()
    ...
    while task.wait(Settings.ClickDelay or 0.0001) do
        -- check cooldown
        if (tick() - Module.AttackCooldown) >= 0.05 then
            -- check auto click on
            if Settings.AutoClick then
                -- check alive
                if Module.IsAlive(client.Character) then
                    -- check có Tool
